...
export async function createUser(email: string, uid: string, theme: 'light' | 'dark' | 'system') {
  await setDoc(
    doc(db, 'users', uid),
    {
      email,
...
export async function updateUserTheme(uid: string, theme: 'light' | 'dark' | 'system') {
